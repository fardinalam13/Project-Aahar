...
<body>
    ...
    <form action="" method="POST">
        <h1>Delete Your Food Item From Following List</h1>
        <br>
        <?php
        // Storing Session
        
        $sql = "SELECT * FROM food_items as f, vendors as v WHERE v.vendor_id = f.vendor_id  and v.vendor_id = '$vendor_id'ORDER BY f.item_id";
        ...
        <tbody>
            <tr>
            <td> <input name="checkbox[]" type="checkbox" value="<?php echo $row['item_id']; ?>"/> </td>
        ...
        if(isset($_POST['checkbox'])){
          ...
          $sql = "DELETE from food_items WHERE item_id in ('$cheks')";
          $result = mysqli_query($conn,$sql);
        }
        else{
